...
Below are instructions for completing the first lab. If you finish all of the github exercises please feel free to work on the first problem set. After the brief lecture the TAs will be walking around the room to help with both the lab and the problem set. The slides included in this lab show instructions for how to complete the lab using the github GUI. 
